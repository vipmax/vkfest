...
new_data_file = io.open('/home/maxpetrov/polyglot_data/full_vocabulary.csv','r', encoding='utf8')
...
f = open('/home/maxpetrov/polyglot_data/data/tmp/sentiment/ru/ru.sent.pkl', 'r')
